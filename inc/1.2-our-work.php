<div class="color-container orange-bg">
  ...
  <section class="body-overlap">
    <span class="banner-caption">Sheena Oldham, a beneficiary of United Way funded programs</span>
    <div class="top-text">
      <h2>We are a Non-Profit that Supports Non Profits</h2>
      <p>Here’s how it works: You donate to United Way of Whatcom County. We carefully vet non-profits and allocate funds. Those non-profits provide services to people in need.</p>
    </div>
    <div class="icon-grid">
      ...
      <div class="icon-column">
        ...
        <h3>Those in need get services</h3>
        <p>We all live better. Every year, tens of thousands of individuals and families in Whatcom County receive support from the non-profit partner agencies we fund.</p>
        <a href="#"></a>
      </div>
    </div>
  </section>
