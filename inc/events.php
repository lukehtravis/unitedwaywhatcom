    ...
    <div class="events-box">
      <div class="event-box">
        ...
        <div class="event-description">
          <p>Join us as we celebrate our most recent annual campaign. Enjoy heavy appetizers. Honor this year's award recipients. Learn where we're heading in 2018 and beyond.</p>
        </div>
        <a href="#"><button class="orange-bg">Sign Up Today</button></a>
      </div>
      <div class="event-box">
        <h2>Annual Campaign Celebration</h2>
        <div class="event details">
